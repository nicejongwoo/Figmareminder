        ...
        <Card className="bg-white border-gray-200">
          <CardContent className="pt-6 pb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-description text-gray-600">현재 스트릭</span>
            </div>
            <div className="text-title text-gray-900 mb-1">{stats.currentStreak}</div>
            <p className="text-description text-gray-500">일 연속</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white border-gray-200">
          <CardContent className="pt-6 pb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-description text-gray-600">주간 완료율</span>
            </div>
        ...
        <Card className="bg-white border-gray-200">
          <CardContent className="pt-6 pb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-description text-gray-600">최장 스트릭</span>
            </div>
            <div className="text-title text-gray-900 mb-1">{stats.longestStreak}</div>
            <p className="text-description text-gray-500">일</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white border-gray-200">
          <CardContent className="pt-6 pb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-description text-gray-600">총 완료</span>
            </div>
            <div className="text-title text-gray-900 mb-1">{stats.totalCompletions}</div>
            <p className="text-description text-gray-500">개</p>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              {unlockedBadges.map(badge => (
                <div
                  key={badge.id}
                  className="p-5 rounded-xl border-2 border-primary/20 bg-primary/5"
                >
                  ...
                  {badge.unlockedAt && (
                    <p className="text-description text-center text-gray-400 mt-2">
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              {lockedBadges.map(badge => (
                <div
                  key={badge.id}
                  className="p-5 rounded-xl border-2 border-gray-200 bg-gray-50 opacity-60"
                >
        ...
        <CardContent className="pt-8 pb-8 text-center">
          {stats.currentStreak >= 7 ? (
            <>
              ...
              <p className="text-[16px] font-medium opacity-95 text-white">
